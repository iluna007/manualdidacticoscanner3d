...
export const estaciones = [
  {
    ...
    tipo: 'estacion',
    nombre: 'Preparación',
    resumen: 'Batería, memoria y Satsurv listos antes de salir.',
    cuerpo: 'Cargá la batería la noche anterior (carga completa en ~2 h con cargador de 45 W), verificá memoria libre y conectá la app Satsurv por Wi-Fi o Bluetooth. Es como cargar la batería de la estación total antes de un levantamiento.',
  ...
  },
  {
    ...
    cuerpo: 'En Satsurv configurá la conexión a tu red de correcciones: NTRIP (usuario + mountpoint por SIM o Wi-Fi) o radio UHF con base propia. Pensalo como un amigo topógrafo parado en un punto conocido que te corrige la posición por teléfono en tiempo real.',
  ...
  },
  {
    ...
    tipo: 'estacion',
    nombre: 'FIX logrado',
    resumen: 'Estado FIJO = centímetros. Luz verde para trabajar.',
    cuerpo: 'Esperá a que el estado diga FIJO (FIX). Eso significa precisión centimétrica. Si dice FLOTANTE, quedate unos segundos bajo cielo despejado hasta que fije. Es el equivalente a cuando la estación total ya está estacionada y lista.',
    tip: '💡 FIJO = centímetros. FLOTANTE = todavía no; no empieces el escaneo georreferenciado.',
    errorNovato: 'Empezar a escanear en FLOTANTE = toda la nube desplazada respecto a coordenadas reales.',
    tiempo: '1–5 min',
  ...
  },
  {
    ...
    cuerpo: 'Creá el proyecto en Satsurv, elegí el sistema de coordenadas (ej. CRTM05) y arrancá el escaneo empezando al aire libre con FIX. Caminá a paso tranquilo y constante; pasadas con traslape. Evitá giros bruscos — confunden al IMU. Bajo árboles o aleros, seguí normal: SLAM-Fix cubre los cortes de señal.',
    tip: '💡 Si pasás bajo techos o puentes, el equipo cambia a SLAM automáticamente sin perder la alineación.',
    errorNovato: 'Correr o girar en U brusco = nube con huecos y trayectoria inestable.',
  ...
  },
  {
    ...
    cuerpo: 'Exportá la nube georreferenciada en coordenadas unificadas (NEZ o BLH, ej. CRTM05 para Costa Rica). Pasala a la computadora — el siguiente transbordo es bajar el archivo del equipo.',
    tip: '💡 Anotá el sistema de coordenadas usado en Satsurv para no mezclar proyectos.',
  ...
  },
  {
    ...
    cuerpo: 'Batería cargada, memoria libre, Satsurv conectado. En modo SLAM la batería interna dura ~2 h; con externa, hasta ~5 h. El SL9 permite cambio en caliente — llevá repuesto.',
    tip: '💡 No necesitás configurar NTRIP ni esperar FIX en esta línea.',
  ...
  },
  {
    ...
    cuerpo: 'Recorré cada habitación a paso constante. En interiores grandes, terminá cerca del inicio y pasá dos veces por los pasillos que conectan zonas. Vidrios, espejos y superficies negras engañan al láser — generan puntos fantasma que se limpian después.',
    tip: '💡 Planificá el recorrido como si dibujaras un recorrido de visita guiada.',
  ...
  },
  {
    ...
    cuerpo: 'Detené el escaneo y revisá la nube en Satsurv. Verificá que no haya huecos grandes ni zonas sin datos antes de exportar.',
  ...
  },
  {
    ...
    tipo: 'estacion',
    nombre: '→ Transbordo',
    resumen: 'La nube viaja en metros desde tu punto cero hacia Extracción.',
  ...
  },
  {
    ...
    cuerpo: 'Acá se encuentran las dos líneas — no importa cómo escaneaste, tenés un archivo de nube cruda que hay que pasar a la computadora (USB, Wi-Fi o tarjeta). Y acá el viaje se bifurca: ¿procesás con el software del fabricante (Sat-LiDAR) o con CloudCompare (gratis)?',
  ...
  },
  {
    ...
    cuerpo: 'Las dos rutas (naranja y morada) se juntan acá. El resultado es un archivo limpio en formato de intercambio estándar, listo para modelar.',
  ...
  },
  {
    ...
    tipo: 'terminal',
    nombre: 'Rhino',
    resumen: 'Estación terminal: importar, verificar, seccionar y modelar.',
