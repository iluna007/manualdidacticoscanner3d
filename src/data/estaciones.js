...
export const estaciones = [
  {
    ...
    cuerpo: 'Cargá la batería la noche anterior (carga completa en ~2 h con el adaptador del kit), verificá que la barra de batería esté bien trabada y conectá Hi-Survey al SL9 por Wi-Fi (recomendado), Bluetooth o NFC. La contraseña Wi-Fi por defecto del equipo es 12345678.',
  ...
  },
  {
    ...
    cuerpo: 'En Hi-Survey abrí [Conectar dispositivo] y elegí Wi-Fi, Bluetooth o red. Para correcciones RTK configurá NTRIP/CORS (usuario + mountpoint) o radio UHF con base propia — el canal y protocolo deben coincidir entre base y rover. La luz de señal parpadea en verde cuando llega RTCM.',
    ...
    imagenAlt: 'Capturas de Hi-Survey con configuración de conexión',
    demo: null,
  ...
  },
  {
    ...
    tip: '💡 Si la batería llega al 5 %, el equipo guarda y cierra la tarea automáticamente.',
