...
export const estaciones = [
  ...
  },
  {
    ...
    cuerpo: 'Acá convergen los dos flujos de campo — no importa cómo escaneaste, tenés un archivo de nube cruda que hay que pasar a la computadora (USB, Wi-Fi o tarjeta). Y acá el flujo se bifurca: ¿procesás con el software del fabricante (Sat-LiDAR) o con CloudCompare (gratis)?',
